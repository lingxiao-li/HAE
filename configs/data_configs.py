...
DATASETS = {
	...
	'flowers_encode_eva': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['flowers_train_eva'],
		'train_target_root': dataset_paths['flowers_train_eva'],
		'test_source_root': dataset_paths['flowers_test_eva'],
		'test_target_root': dataset_paths['flowers_test_eva'],
	},
	'animalfaces_encode': {
		'transforms': transforms_config.EncodeTransforms,
	...
	'animalfaces_encode_eva': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['animal_faces_train_eva'],
		'train_target_root': dataset_paths['animal_faces_train_eva'],
		'test_source_root': dataset_paths['animal_faces_test_eva'],
		'test_target_root': dataset_paths['animal_faces_test_eva'],
	},
	'vggfaces_encode': {
		'transforms': transforms_config.EncodeTransforms,
