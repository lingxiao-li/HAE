...
class TwoCropTransform:
    """Create two crops of the same image and one traget"""
    def __init__(self, source_transform, target_transform, train_transform):
        self.source_transform = source_transform
        self.target_transform = target_transform
        self.train_transform = train_transform
    
    def __call__(self, x):
        return [self.source_transform(x), self.train_transform(x), self.target_transform(x)]
